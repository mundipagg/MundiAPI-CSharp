...
```csharp
Task<Models.GetSubscriptionResponse> UpdateSubscriptionStartAt(string subscriptionId, Models.UpdateSubscriptionStartAtRequest request)
```
...
Models.GetSubscriptionResponse result = await subscriptions.UpdateSubscriptionStartAt(subscriptionId, request);
...
### <a name="update_current_cycle_end_date"></a>![Method: ](https://apidocs.io/img/method.png "MundiAPI.PCL.Controllers.SubscriptionsController.UpdateCurrentCycleEndDate") UpdateCurrentCycleEndDate

> TODO: Add a method description


```csharp
Task<Models.GetSubscriptionItemResponse> UpdateCurrentCycleEndDate(string subscriptionId, Models.UpdateCurrentCycleEndDateRequest request)
```
...
Models.GetSubscriptionItemResponse result = await subscriptions.UpdateCurrentCycleEndDate(subscriptionId, request);
...
```csharp
Task UpdateCurrentCycleStatus(string subscriptionId, Models.UpdateCurrentCycleStatusRequest request)
```
...
await subscriptions.UpdateCurrentCycleStatus(subscriptionId, request);
...
### <a name="remove_invoice_usage"></a>![Method: ](https://apidocs.io/img/method.png "MundiAPI.PCL.Controllers.InvoicesController.RemoveInvoiceUsage") RemoveInvoiceUsage

> Remove a usage from an invoice


```csharp
Task<Models.GetInvoiceResponse> RemoveInvoiceUsage(string invoiceId, string usageId)
```
...
Models.GetInvoiceResponse result = await invoices.RemoveInvoiceUsage(invoiceId, usageId);

```


### <a name="remove_invoice_usages"></a>![Method: ](https://apidocs.io/img/method.png "MundiAPI.PCL.Controllers.InvoicesController.RemoveInvoiceUsages") RemoveInvoiceUsages

> Remove usages from an invoice


```csharp
Task<Models.GetInvoiceResponse> RemoveInvoiceUsages(string invoiceId)
```
...
Models.GetInvoiceResponse result = await invoices.RemoveInvoiceUsages(invoiceId);
