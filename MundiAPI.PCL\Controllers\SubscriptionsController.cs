...
namespace MundiAPI.PCL.Controllers
{
    public partial class SubscriptionsController: BaseController, ISubscriptionsController
    {
        ...
        /// <param name="subscriptionId">Required parameter: Subscription id</param>
        /// <return>Returns the Models.GetSubscriptionResponse response from the API call</return>
        public Models.GetSubscriptionResponse UpdateSubscriptionCreditCard(Models.UpdateSubscriptionCardRequest body, string subscriptionId)
        {
        ...
        /// <param name="subscriptionId">Required parameter: Subscription id</param>
        /// <return>Returns the Models.GetSubscriptionResponse response from the API call</return>
        public async Task<Models.GetSubscriptionResponse> UpdateSubscriptionCreditCardAsync(Models.UpdateSubscriptionCardRequest body, string subscriptionId)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
