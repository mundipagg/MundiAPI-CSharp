...
namespace MundiAPI.PCL.Controllers
{
    public partial class SubscriptionsController: BaseController, ISubscriptionsController
    {
        ...
        /// <return>Returns the Models.GetSubscriptionResponse response from the API call</return>
        public Models.GetSubscriptionResponse RescheduleSubscription(string subscriptionId, Models.CreateRescheduleSubscriptionRequest body)
        {
            Task<Models.GetSubscriptionResponse> t = RescheduleSubscriptionAsync(subscriptionId, body);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="body">Required parameter: Request for updating the billing day of a subscription</param>
        /// <return>Returns the Models.GetSubscriptionResponse response from the API call</return>
        public async Task<Models.GetSubscriptionResponse> RescheduleSubscriptionAsync(string subscriptionId, Models.CreateRescheduleSubscriptionRequest body)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
