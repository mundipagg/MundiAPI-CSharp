...
namespace MundiAPI.PCL.Controllers
{
    public partial interface ISubscriptionsController
    {
        ...
        /// <param name="subscriptionId">Required parameter: Subscription id</param>
        /// <return>Returns the Models.GetSubscriptionResponse response from the API call</return>
        Models.GetSubscriptionResponse UpdateSubscriptionCreditCard(Models.UpdateSubscriptionCardRequest body, string subscriptionId);
        ...
        /// <param name="subscriptionId">Required parameter: Subscription id</param>
        /// <return>Returns the Models.GetSubscriptionResponse response from the API call</return>
        Task<Models.GetSubscriptionResponse> UpdateSubscriptionCreditCardAsync(Models.UpdateSubscriptionCardRequest body, string subscriptionId);
